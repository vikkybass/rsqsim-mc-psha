...
from gmpe_calculator import GMPECalculator, calculate_ground_motion
from rupture_geometry import EventRupture, RSQSimGeometryReader
...
class RSQSimGMPEAdapter:
    ...
    def __init__(self,
        ...
        logger.info(f"📊 RSQSim-GMPE Adapter initialized")
        logger.info(f"   Using ensemble: {use_ensemble}")
        logger.info(f"   Default Vs30: {vs30} m/s")
        logger.info(f"   Geometry reader: {'Available' if geometry_reader else 'Not available'}")
