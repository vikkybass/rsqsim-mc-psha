...
class ScenarioBuilder:
    ...
    def _create_cb14_scenario(self,
        ...
        if depth_2_5 is None:
            depth_2_5 = self._calculate_depth_2_5(vs30, region)
    ...
    def _calculate_depth_1_0(self, vs30: float, region: str = 'california') -> float:
        ...
        return z1_m / 1000.0  # Convert to km
    
    def _calculate_depth_2_5(self, vs30: float, region: str = 'global') -> float:
        """
        Calculate Z2.5 using empirical relationship
        
        Based on Campbell & Bozorgnia (2014) equations
        """
        if region == 'japan':
            z2p5 = 5.359 - 1.102 * np.log(vs30)
        else:
            z2p5 = 7.089 - 1.144 * np.log(vs30)
