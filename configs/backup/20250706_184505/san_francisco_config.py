"""
Enhanced San Francisco Bay Area Configuration with Visualization Options
...
def load_config():
    ...
    sf_config = {
        ...
        "paths": {
            ...
            "windows_dir": f"{RSQSIM_WORK_DIR}/data/Catalog_4983/windows/san_francisco/sequential",
            "output_dir": f"{RSQSIM_WORK_DIR}/output/san_francisco/sequential", 
            "log_dir": f"{RSQSIM_WORK_DIR}/logs/san_francisco/multi_site",
            
            # Backup directories
            "backup_dir": f"{RSQSIM_PROJECT_DIR}/rsqsim_results/san_francisco/multi_site",
            "archive_dir": f"{RSQSIM_PROJECT_DIR}/rsqsim_archive/san_francisco/multi_site",
        },
        ...
        "site": {
            ...
            "grid_lat_spacing": 0.1,   # ~5.5km for Bay Area detail
            ...
            "sites": [
                ...
                (37.42, -122.08),  # Palo Alto
                (37.54, -122.31)   # San Mateo
            ],
        ...
        # Major Bay Area cities for mapping
        "major_cities": {
...
def filter_sites_to_region(sites, region_name='san_francisco'):
...
if __name__ == "__main__":
    ...
    if is_valid:
        print(f"\n🚀 READY TO RUN:")
        print(f"python scripts/run_mc.py --region san_francisco --mode sequential --log-level INFO")
    else:
