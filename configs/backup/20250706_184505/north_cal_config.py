"""
Enhanced North_cal Configuration with Visualization Options
...
def load_config():
    ...
    north_cal_config = {
        ...
        "paths": {
            ...
            "windows_dir": f"{RSQSIM_WORK_DIR}/data/Catalog_4983/windows/north_cal/sequential",
            "output_dir": f"{RSQSIM_WORK_DIR}/output/north_cal/sequential", 
            "log_dir": f"{RSQSIM_WORK_DIR}/logs/north_cal/multi_site",
            
            # Backup directories
            "backup_dir": f"{RSQSIM_PROJECT_DIR}/rsqsim_results/north_cal/multi_site",
            "archive_dir": f"{RSQSIM_PROJECT_DIR}/rsqsim_archive/north_cal/multi_site",
        },
        ...
        "site": {
            ...
            "grid_lat_spacing": 0.1,   # ~9km for Bay Area detail
        ...
        "major_cities": {
           ...
           "Chico": (-121.84, 39.73),
           "Yuba City": (-121.61, 39.16),
           "Eureka": (-124.08, 40.87),
           "Ukiah": (-123.21, 39.15),
           "Santa Rosa": (-122.71, 38.44),
           "Petaluma": (-122.64, 38.23),
           "Napa": (-122.29, 38.30),
           "Fairfield": (-122.04, 38.25)
        }
    }
...
def filter_sites_to_region(sites, region_name='north_cal'):
...
if __name__ == "__main__":
    ...
    if is_valid:
        print(f"\n🚀 READY TO RUN:")
        print(f"python scripts/run_mc.py --region north_cal --mode sequential --log-level INFO")
    else:
